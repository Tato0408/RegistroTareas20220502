...
import me from './src/routes/me/meRoutes.js'
...
app.use("/api/loginTeachers", loginTeacher)                        // ← corregido
app.use("/api/recoveryPasswordTeachers", recoveryPasswordTeacher)  // ← corregido
