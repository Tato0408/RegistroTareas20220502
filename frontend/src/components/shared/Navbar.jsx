...
export default function Navbar() {
  ...
  const userMock = { name: "Daniel Eli", role: "Profesor" };
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-slate-700 leading-none">{userMock.name}</p>
                <p className="text-xs text-slate-500 mt-1">{userMock.role}</p>
              </div>
